<script>
  import { closeSideMenu, pageMenus, togglePageMenu } from './store';
  ...
  export let links = [
    ...
    },
    {
      ...
      sublinks: [
        { name: 'Ventas', url: '/admin/cliente/ventas/' },
        { name: 'facturacion', url: '/admin/cliente/facturas/' },
      ],
    },
  ]
</script>

<div class="fixed py-4 text-gray-500 dark:text-gray-400">
  {#if withTitle}
    <a class="ml-6 text-xl font-bold text-gray-800 dark:text-gray-200" href="/"> MiPasaje </a>
  {/if}
  ...
  <div class="px-6 my-6">
    <button
      ...
      on:click={() => {goto('/admin/cliente/rutas/')}}
      >
      Crear oferta
